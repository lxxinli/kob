            ...
            <div class="col-9">
                <div class="card" style="margin-top: 20px;">
                    <div class="card-header">
                        ...
                        <button type="button" class="btn btn-warning float-end" data-bs-toggle="modal" data-bs-target="#add-bot-btn">
                            创建Bot
                        </button>
...
export default {
    ...
    setup() {
        ...
        const refresh_bots = () => {
            $.ajax({
                url: "http://47.116.187.43/api/user/bot/getlist/",
                type: "get",
                headers: {
        ...
        const add_bot = () => {
            ...
            $.ajax({
                url: "http://47.116.187.43/api/user/bot/add/",
                type: "post",
                data: {
                    title: botadd.title,
                ...
                success(resp) {
                    if (resp.response_message === "success") {
                        ...
                        botadd.error_message = resp.response_message;
                    }
                }
            })
        }
        ...
        const update_bot = (bot) => {
            botadd.error_message = "";
            $.ajax({
                url: "http://47.116.187.43/api/user/bot/update/",
                type: "post",
                data: {
                    bot_id: bot.id,
                    title: bot.title,
        ...
        const remove_bot = (bot) => {
            $.ajax({
                url: "http://47.116.187.43/api/user/bot/remove/",
                type: "post",
                data: {
                    bot_id: bot.id,
                },
